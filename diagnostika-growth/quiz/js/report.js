...
(function () {
  ...
  function renderHotIcpBlock(noFinance) {
    const items = [
      'Откроем ваш расчёт упущенной прибыли и&nbsp;покажем, где она реально утекает',
      'Подберём 3&nbsp;отчёта, которые закроют 80% управленческих вопросов в&nbsp;вашей отрасли',
      'Сформулируем 2–3 первых шага&nbsp;— конкретный план на&nbsp;30&nbsp;дней под вашу боль'
    ];
    if (noFinance) {
      items.push('Подберём финансиста из&nbsp;500+ партнёров, который ведёт учёт под Финтабло&nbsp;— чтобы не&nbsp;вешать это на&nbsp;себя');
    }

    return (
      '<div class="dg-final-eyebrow">Бесплатно · 30&nbsp;минут · эксперт-практик</div>' +
      '<h2>Разберём ваш расчёт упущенной прибыли с&nbsp;экспертом&nbsp;— и&nbsp;соберём план, как её удержать</h2>' +
      '<p>На&nbsp;встрече финансовый эксперт Финтабло (500+ внедрений) открывает ваш расчёт, проверяет три ключевые цифры и&nbsp;формулирует конкретный план под вашу главную боль. Унесёте с&nbsp;собой готовый roadmap на&nbsp;30&nbsp;дней&nbsp;— можно работать сразу, сами или вместе с&nbsp;нами.</p>' +
      ...
      '</div>' +
      buildLeadForm({
        title: 'Оставьте контакт&nbsp;— подберём время и&nbsp;пришлём ссылку на&nbsp;встречу',
        cityField: false,
        submitText: 'Записаться на разбор финансов',
