...
(function () {
  ...
  const RECOMMENDATIONS = {
    margin_blind: {
      ...
      body: 'Прибыль по проектам, направлениям или объектам по факту — а не на годовом итоге, когда уже поздно реагировать. Решение закрыть убыточное направление или вложить в прибыльное — на основе данных, а не интуиции.',
      decomposition: [
