...
(function () {
  ...
  const RECOMMENDATIONS = {
    ...
    cash_surprise: {
      ...
      body: 'Прогноз поступлений и выплат на 8-12 недель вперёд по реальным данным с банковских счетов. Разрыв виден заранее — есть время договориться с банком, поставщиком или клиентом, а не решать вопрос в последний день.',
      decomposition: [
