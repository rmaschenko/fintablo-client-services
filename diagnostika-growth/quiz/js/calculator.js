...
(function () {
  ...
  const RECOMMENDATIONS = {
    ...
    blind_decisions: {
      ...
      body: 'Прежде чем брать новый проект или нанимать человека — видеть, как это влияет на прибыль, кассу и устойчивость бизнеса. Контроль по трём опорам: движение денег, прибыль и убыток, состояние активов.',
      decomposition: [
