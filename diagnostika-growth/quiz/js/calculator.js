...
(function () {
  ...
  const RECOMMENDATIONS = {
    margin_blind: {
      title: 'Видеть, какие направления реально кормят бизнес',
      body: 'Маржа по проектам, направлениям или объектам в моменте — а не на годовом итоге, когда уже ничего не вернуть. Решение закрыть убыточное направление или вложить в прибыльное — на основе цифры, не интуиции.',
