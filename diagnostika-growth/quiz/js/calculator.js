  ...
  const RECOMMENDATIONS = {
    margin_blind: {
      ...
      decomposition: [
        ...
        'На общих показателях кажется «всё ок», а 1–2 направления тихо тянут вниз'
      ],
    ...
    blind_decisions: {
      titleByRole: {
        owner:      'Опирать решения по найму, проектам и инвестициям на данные, а не на ощущения',
        ...
        other:      'Опирать решения по найму и проектам на данные, а не на ощущения'
      },
      ...
      roadmap: {
        in_3m: 'Триада отчётов работает, видите бизнес «как на ладони». Решения по проектам и найму — с расчётом',
